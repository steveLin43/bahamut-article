...
def get_article_content() -> None:
    ...
    try:
        ...
        str_list.append(crawler_baha.get_content_by_page(soup))
        if no_picture:
            picture_number = crawler_baha.download_pictures_from_soup(soup, dir_name, article_title, picture_number, 1) ## 目前無找到條件文章測試，因此先沿用
